...
In other words, given the assertion that the persistence module $M$ has a persistence diagram, the Morse inequalities simply express the fact that the number of right endpoints in nonnegative.
