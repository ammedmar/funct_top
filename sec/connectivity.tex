...
If $f_{\leq t}$ is compact then the function $f$ is necessarily lower-semicontinuous and bounded from below, see \cite[p.~444]{Morse.1939} or \cite[Theorem 3.1]{Struwe.1988}.
...
We now describe a weaker version of local connectivity of sublevel set filtrations that implies q-tameness when continuity is assumed.
