...
If $f_{\leq t}$ is compact for all $t$, then the function $f$ is necessarily lower-semicontinuous and bounded from below (see \cite[p.~444]{Morse.1939} and \cite[Theorem I.3.1]{Struwe.1988}).
