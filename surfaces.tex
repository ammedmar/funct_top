...
In particular, Morse and Tompkins use in their applications to minimal surface theory the following version equivalent to $\piLC$:
...
Unfortunately, this argument is not in general sound as \cref{thm:counterexample} shows.
...
This implies that Morse inequalities hold, and hence so does the unstable minimal surfaces theorem of Morse.