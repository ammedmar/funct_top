...
\begin{lem} \label{l:key lemma for q-tameness}
	Let $f \colon X \to \R$ be a function on a locally compact space $X$ whose sublevel set filtration is compact and $\HLC$ below $u \in \R$, and consider subsets $C \subseteq L \subseteq X$ with $C$ compact and $L$ open.
