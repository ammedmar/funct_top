...
\title{Persistence in functional analysis and a correction to a theorem of Morse}


\author{author1 \and author2 \and author3}

\institute{author1 \at where \\ \email{@} \and
	author2 \at where \\ \email{@} \and
	author3 \at where \\ \email{@} \and
}
...
\begin{abstract}
	...
	Morse and Tompkins applied this body of work to prove the Unstable Minimal Surface Theorem in the setting defined by Douglas' solution to Plateau's Problem.
	In recent years, persistence homology has led to fast passed developments in both mathematical theory and practice within several fields including simplectic geometry, WHAT ELSE? and neuroscience. In this article, we present a modern account of Morse's functional topology from the point of view of persistence theory.
	We do so to allow for future applications of persistence techniques in functional analysis, as well as to correct a gap we identified in the proof of the Unstable Minimal Surface Theorem of Morse and Tompkins.
\end{abstract}
