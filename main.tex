...
\begin{abstract}
	During the 1930's Morse developed a general theory, which he called functional topology, relating the critical set of a semi-continuous functional and the topology of its sublevel sets, and, in join work with Tompkins, used this theory to study minimal surfaces.
	...
	With modern applications to geometry in mind, in this article we present a comprehensive and up-to-date study of the most delicate of these conditions: local-connectivity. Providing, on passing, a correction to the Critical Surface Theorem of Morse and Tompkins.
\end{abstract}
