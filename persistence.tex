...
The most general stability result is shown by considering as an intermediate step the metric space of filtrations and persistence modules equipped with the \emph{interleaving distance} \cite{MR2279866}.
